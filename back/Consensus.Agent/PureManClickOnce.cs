...
// Copied from: https://github.com/derskythe/WpfSettings/blob/master/PureManApplicationDevelopment/ClickOnceDeploymentException.cs
// Thanks @derskythe :)
...
namespace Consensus.Agent
{
    ...
    public class PureManClickOnce
    {
        ...
        {
            // For easier debug - we do not support other options anyway
            return true;
